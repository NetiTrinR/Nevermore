	...
	<div class="well">
		<form action="{{ URL::route('create')}}" method="post">
			...
			<div class="control-group {{ ($errors->has('first_name') ? 'error' : '') }}" for="first_name">
	            <div class="controls">
	            	<input name="first_name" id="first_name" value="{{ Request::old('first_name') }}" type="text" class="span7 input-xlarge" placeholder="First Name"><br />
			...
			<div class="control-group {{ ($errors->has('last_name') ? 'error' : '') }}" for="last_name">
	            <div class="controls">
	            	<input name="last_name" id="last_name" value="{{ Request::old('last_name') }}" type="text" class="span7 input-xlarge" placeholder="Last Name"><br />
			...
			<div class="control-group {{ ($errors->has('username') ? 'error' : '') }}" for="username">
	            <div class="controls">
	                <input name="username" id="username" value="{{ Request::old('username') }}" type="text" class="span7 input-xlarge" placeholder="Username"><br />
			...
			<div class="control-group {{ ($errors->has('mcname') ? 'error' : '') }}" for="mcname">
	            <div class="controls">
	                <input name="mcname" id="mcname" value="{{ Request::old('mcname') }}" type="text" class="span7 input-xlarge" placeholder="Minecraft Username"><br />
	        ...
	        <div class="control-group {{ ($errors->has('email') ? 'error' : '') }}" for="email">
	            <div class="controls">
	                <input name="email" id="email" value="{{ Request::old('email') }}" type="text" class="span7 input-xlarge" placeholder="E-mail"><br />
	        ...
	        <div class="control-group {{ ($errors->has('email_confirmation') ? 'error' : '') }}" for="email_confirmation">
	            <div class="controls">
	                <input name="email_confirmation" id="email_confirmation" value="{{ Request::old('email_confirmation') }}" type="text" class="span7 input-xlarge" placeholder="Confirm Email"><br />
			...
			<div class="control-group {{ ($errors->has('password') ? 'error' : '') }}" for="password">
				<div class="controls">
					<input name="password" value="" type="password" class="span7 input-xlarge" placeholder="Password"><br />
			...
			<div class="control-group {{ ($errors->has('password_confirmation') ? 'error' : '') }}" for="password_confirmation">
				<div class="controls">
					<input name="password_confirmation" value="" type="password" class="span7 input-xlarge" placeholder="Confirm Password"><br />
